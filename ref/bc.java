	...
	public void enterCellPhoneNumber()  {
		String DphoneNumber = dataTable.getData("PersonalInfoScreen", "phoneNumber").trim();
		try {
	...
	public void enterMailAddresss()  {
		String DmailAddress1 = dataTable.getData("PersonalInfoScreen", "mailAddress1").trim();
		String DmailAddress2 = dataTable.getData("PersonalInfoScreen", "mailAddress2").trim();
		try {
	...
	public void enterPassword()  {
		try {
			String Dpassword1 = dataTable.getData("PersonalInfoScreen", "password1").trim();
			String Dpassword2 = dataTable.getData("PersonalInfoScreen", "password2").trim();
	...
	public void confirmationscreen()  {
		...
		boolean Elmconfirmationtxt = businessComponents.GeneralComponents.waitforvisibilityOfElement(driver,PersonalInfoScreen.confirmationscreen,10);
