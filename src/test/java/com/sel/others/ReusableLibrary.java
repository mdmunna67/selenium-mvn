...
public abstract class ReusableLibrary {
	...
	Dimension winSize;
	/**
	 * The {@link SelDataTable} object (passed from the test script)
	 */
	protected SelDataTable dataTable;
	/**
	 * The {@link SeleniumReport} object (passed from the test script)
	 */
	protected SeleniumReport report;
	/**
	 * The {@link SelDriver} object
	 */
	...
	public ReusableLibrary(ScriptHelper scriptHelper) {
		...
		this.driver = scriptHelper.getselDriver();
    ...
    public  void scrollNClick(By listItems, String Text){
        boolean flag = false;
