...
public class SelDataTable {
	...
	/**
	 * Constructor to initialize the {@link SelDataTable} object
	 * 
	 * @param datatablePath
	 ...
	 */
	public SelDataTable(String datatablePath, String datatableName) {
	...
	private void checkPreRequisites() {
		if (currentTestcase == null) {
			throw new FrameworkException(
					"SelDataTable.currentTestCase is not set!");
		}
		if (currentIteration == 0) {
			throw new FrameworkException(
					"SelDataTable.currentIteration is not set!");
		}
		if (properties.getProperty("Approach")
				.equalsIgnoreCase("KeywordDriven")) {
			if (currentSubIteration == 0) {
				throw new FrameworkException(
						"SelDataTable.currentSubIteration is not set!");
			}
		}
	}
	...
	public void putData(String datasheetName, String fieldName, String dataValue) {
		...
		synchronized (SelDataTable.class) {
