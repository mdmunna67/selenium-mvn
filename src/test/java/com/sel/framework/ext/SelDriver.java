...
public class SelDriver implements WebDriver , JavascriptExecutor{
...
//	private MobileWebDriver seeTestDriver;
	...
	public SelDriver(WebDriver driver) {
		this.driver = driver;
	}
...
//	}
//	
//	public MobileWebDriver getMobileDriver(){
...
//	}
	...
	public void tap(int fingers, WebElement element, int duration) {
		((SelDriver) driver).tap(fingers, element, duration);
	}
