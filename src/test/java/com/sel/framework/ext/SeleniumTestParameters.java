...
import com.sel.framework.TestParameters;
...
//		return this.deviceName + "-" + this.mobileToolName;
		String deviceInfo =this.deviceName;
		if (this.deviceName == null) {
			throw new FrameworkException(
					"The Mobile Device ID has not been Set in Run Manager!");
		}else if (this.deviceName.equals("")) {
			deviceInfo = this.mobileModel+" / "+this.mobileOsVersion;
...
//				if(this.mobileToolName.toString().equalsIgnoreCase("REMOTE_WEBDRIVER")){
//					this.deviceName = browser.toString();
//					deviceInfo = this.deviceName;
//				}
//			}			
//		}
		return deviceInfo;// + "-" + this.mobileToolName;
