...
public class TestMobForTransactionWithOldRecipient extends SelTestCase {

		@Test(dataProvider = "TestMobForTransactionWithOldRecipient")
		public void testRunner(String testInstance, ExecutionMode executionMode, MobileToolName mobileToolName,
			...
			testParameters.setCurrentTestDescription("Test for Transaction With OldRecipient in mobile");
...
//			testParameters.setMobileModel(mobilemodel);
		...
		@DataProvider(name = "TestMobForTransactionWithOldRecipient", parallel = true)
